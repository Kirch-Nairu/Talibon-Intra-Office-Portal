...
export default function AppLayout({ title, children }: Props) {
    ...
    const nav = [
        ...
        { label: 'Memoranda', href: '#', icon: FileText, show: true },
        { label: 'Legislation', href: '#', icon: Gavel, show: true },
