        ...
        <div className="mx-auto max-w-7xl space-y-6">
            <header className="rounded-xl border border-slate-200 bg-white p-5  sm:p-7">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    <div>
                        <div className="text-xs font-bold uppercase tracking-wider text-blue-700">Own-office operational workspace</div>
            ...
            <section>
                <div className="mb-3"><div className="text-xs font-bold uppercase tracking-wider text-blue-700">Office overview</div><h2 className="mt-1 text-xl font-bold text-slate-950">What is happening inside this office?</h2></div>
                <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
                    {metricEntries.map((metric, index) => {
                        const Icon = metricIcons[index % metricIcons.length];
                        return <a key={metric.label} href={metric.link} className="rounded-xl border border-slate-200 bg-white p-4  transition hover:border-blue-300">
            ...
            <div className="grid gap-5 xl:grid-cols-[1.1fr_0.9fr]">
                <section className="overflow-hidden rounded-xl border border-slate-200 bg-white ">
                    <div className="border-b border-slate-100 px-5 py-4 sm:px-6"><div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-blue-700"><Users size={16} /> Staff workload</div><p className="mt-1 text-sm text-slate-500">Bounded assignment summary. No private HR fields are included.</p></div>
                    <div className="overflow-x-auto">
                        <table className="min-w-full text-left text-sm">
                            <thead className="bg-slate-50 text-[13px] uppercase tracking-wide text-slate-500"><tr><th className="px-5 py-3">Employee</th><th className="px-4 py-3">Active</th><th className="px-4 py-3">Overdue</th><th className="px-4 py-3">Action</th></tr></thead>
            ...
            <section className="rounded-xl border border-slate-200 bg-white p-5  sm:p-6">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between"><div><div className="text-xs font-bold uppercase tracking-wider text-blue-700">Recent office activity</div><h2 className="mt-1 text-xl font-bold text-slate-950">Latest authoritative workflow events</h2></div><div className="text-xs text-slate-400">Latest {activityLimit} maximum</div></div>
